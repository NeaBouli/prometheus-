...
Operational branch: `docs/GH-9-signature-import-merge-evidence`; product and bridge changes remain PR-only, and foreign untracked `Prometheus-1.png` remains untouched
Latest verified rollout/docs baseline: `f79150d77ebbf8c71ec8051dc22c7a126d4f38c0 feat: harden GH-9 signature import (#23)`
Latest in-progress task: obtain an explicitly approved external BIP340 signature for the preserved GH-9 H-001 schema-v2 handoff without exposing private material; import and full verification must pass before any explicitly acknowledged one-shot broadcast
