...
Latest CI note: main Prometheus CI `29455597727`, Security Audit `29455597677`, and Pages `29455597066` passed for exact merged public-status commit `e9a970a9d3dbaa98cd754a4149075c0cca866001`. Live GitHub README, index, roadmap, and whitepaper expose the `205e1ca` exact-main handoff, byte-identical rebuild, live UTXO revalidation, 68-72% core estimate, and unchanged external execution gates. Current rollout issue https://github.com/NeaBouli/prometheus-/issues/9 remains open.
