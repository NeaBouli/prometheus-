...
Current CI hardening note: Prometheus CI now declares workflow-level `contents: read` permissions and pins both Rust jobs to toolchain `1.95.0`, matching the locally verified compiler. Fixture CI cannot replace the real funded testnet-10/signature/receipt/public-evidence rollout gate.
