...
- Local evidence so far: 6 schema tests, 8 focused client tests, 44 Guardian P2P unit tests plus 3 process tests, 229 workspace tests with two intentional live-network ignores, Rustfmt, and warning-free workspace/all-target Clippy pass.
