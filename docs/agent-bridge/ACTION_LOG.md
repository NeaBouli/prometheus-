...
- No contract, network, chain, wallet, key, signature, raw transaction, broadcast, slash ACL, commit-reveal formula, KAS/PROM split, or Guardian-reputation behavior changed. PR checks, merge, exact-main evidence, and live Pages verification remain pending.
