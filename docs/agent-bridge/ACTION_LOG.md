...
- Local evidence passes 15 focused Rust tests plus one compile-fail doctest, 15 focused Python tests, 256 workspace Rust tests with two intentional live-network ignores, and 178 Guardian Python tests with three intentional live-model skips. Rustfmt, warning-free workspace all-target Clippy, locked optimized Guardian/proof builds, verified package sets, Black, Ruff, full Guardian Pylint 9.86/10, focused Pylint 10.00/10, and diff checks pass.
