...
- PR #43 initially passed all nine protected contexts in Prometheus CI `29467187250` and Security Audit `29467187280`; CodeRabbit passed with the five findings above. The fix commit, refreshed protected checks, merge, exact-main CI/Security/Pages, and live public verification remain pending.
