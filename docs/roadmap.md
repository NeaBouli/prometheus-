...
- GH-152, not production-deployed: governed schema v5 permanently enforces one-to-one-to-one statement-digest, approval-ID and observable-commitment pairing across outbox/result retention; empty v4 state migrates losslessly and nonempty v4 state fails closed unchanged
