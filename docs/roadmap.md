...
- Merged and exact-main-verified GH-253/PR #254 at `5920cb4bb737376977f762beb0d5e3108519c7a0`: exact dual-signed BIP340 envelopes require the durable current authority to authorize a gapless successor and the proposed key to prove possession under an independent digest domain. Rotation binds current membership, validity and nonce; durable key/history/clock state, replay rejection, historic-key exclusion, restart behavior, schema-v1 migration and concurrent rotation/transition serialization are tested. Later membership transitions verify only the current durable key. Prometheus CI `34031999904`, Security Audit `34031999907`, and Pages `34031999575` pass. This is owner-local succession consistency without a signer/private-key path; real-world key ownership, external/decentralized membership authority, Sybil resistance, L1, public multi-host operation, deployment and production trust remain open
