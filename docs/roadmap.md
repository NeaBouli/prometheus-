...
- GH-205 composes one owner-pinned complete snapshot through the GH-203 observation boundary, a credential-free loopback-only local IPFS gateway fetch, exact Raw-CIDv1 content binding, and one atomic scanner replacement. It remains callable-only development plumbing; automatic updates, canonical manifest authority, independent RPC truth/finality, IPFS availability/replication, production YARA, durable anti-downgrade state, deployment, and production readiness remain open
