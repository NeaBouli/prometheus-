...
3. **[P1] Sprint 10B: Guardian Decentralization** — GH-33 hybrid routing and GH-36 local complete-ballot voting are merged; GH-39 implements local BIP340 authentication plus persistent replay/equivocation protection. Next are the actual P2P carrier with discovery/NAT traversal, trusted membership/key assignment, Sybil resistance, and an explicit on-chain-attestation decision.
