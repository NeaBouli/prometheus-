...
- GH-161 is merged and exact-main verified at `d468426`: canonical exact-byte owner-local model-directory manifests and capture-time re-verification close caller-only local digest derivation, but not upstream authenticity, live served-model identity, semantic quality, calibration, or production authorization. CI `31340112225`, Security `31340112204`, and Pages `31340111625` pass.
