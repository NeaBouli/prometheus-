...
- Merged and exact-main-verified GH-42/GH-44/GH-48/GH-52/GH-55 implement bounded ballot and ThreatHint transport, persistent identity, relay/AutoNAT operation, packaged sidecars, explicit bootstrap advertisements, and the Light Client hint builder. The operated sidecar rejects hints pending real Groth16 verification and a dedicated owner-only ingress. Real two-host operation, accepted ThreatHint analysis, broad discovery, trusted membership/key assignment, Sybil resistance, and on-chain attestation remain open. mDNS is excluded because its compatible optional dependency path has unresolved RustSec advisories.
...
3. **[P1] Sprint 10B: Guardian Decentralization** — GH-33/36/39 plus merged/exact-main-verified GH-42/GH-44/GH-48/GH-52/GH-55 are implemented. Issue #58 tracks owner-only ThreatHint verifier ingress, persistent freshness/replay admission, and bounded analyzer handoff while real Groth16 acceptance stays gated. Real two-host operation, broad discovery, trusted membership/key assignment and rotation, Sybil resistance, and an explicit on-chain-attestation decision follow.
