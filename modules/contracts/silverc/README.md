...
Current operator coverage is 38 unit/security tests, including a fixed public
...
fee/mass tamper guards, plus canonical public-signature import failure and
normalized path-collision guards.
