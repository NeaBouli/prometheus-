...
- Public orchestrator-result receipt import: confirmed external deploy results are bound to the verified request set, converted into `operator_record` receipts, rejected if they contain secret-like fields, and re-validated before status staging.
