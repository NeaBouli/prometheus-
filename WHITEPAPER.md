...
- GH-207 adds owner-local restart-persistent rollback/equivocation rejection for that development path using verified virtual-DAA ordering, canonical exact-identity digests, restrictive POSIX file handling, and exact replay recovery; no auto-update loop, canonical manifest authority, availability/replication proof, or production YARA is added
