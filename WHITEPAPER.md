...
- GH-205 composes a complete owner-pinned snapshot through that observation boundary, a restricted local loopback IPFS gateway, repeated exact CID/content verification, and one atomic scanner swap; no auto-update loop, canonical manifest authority, availability/replication proof, production YARA, or durable anti-downgrade state is added
