...
Public project status was reviewed through 2026-09-06. The immutable claim-audit baseline remains 2026-08-14; later exact-main updates, including GH-253, are recorded below and in the machine-readable post-audit ledger.
...
**Internal engineering estimate (confirmed unchanged 2026-09-06):** the isolated H-001 Testnet-10 canary work item is complete. The rollout-capable core is estimated at **84–88%** and the complete roadmap vision at **50–55%**. These are internal, scope-weighted engineering estimates, not evidence of production readiness, calendar progress, network decentralization, or release timing. The [2026-08-14 claim-audit baseline](docs/claim-audit-2026-08-14.md) lists the remaining evidence gates.
