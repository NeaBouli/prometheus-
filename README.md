...
| 10B — Guardian Decentralization | IN PROGRESS | The merged/exact-main-verified GH-33 router runs 8B first and escalates below confidence `0.70` to 70B while preserving the `0.85` submission threshold. Live model wiring/evidence, calibrated model confidence, and 5+ Guardian ensemble voting remain open. |
