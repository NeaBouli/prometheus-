...
| 9 — Deploy Path | BLOCKED | Current-Silverc runtime gates, release-bundle manifest/archive, deploy preflight, operator runbook, metrics-oracle report preflight, and unsigned oracle tx request pass; network deploy/orchestration and release hardening remain |
