...
| Letzter grün verifizierter Produkt-/Tooling-Commit | `c8038e93` — docs closeout after GH-42; Prometheus CI `29469319855`, Security `29469319851`, and Pages `29469319460` green |
| Aktuelle Tooling-Baseline | Exact main `c8038e93` passed all protected jobs plus Pages. The GH-44 branch candidate adds owner-only persistent transport identity, strict bounded direct/relay/AutoNAT routes, a bounded relay service, data-minimal health events, and isolated three-node relay/AutoNAT/DCUtR-fallback/disconnect evidence. Protected merge, public/multi-host operation, broad discovery, trusted membership/key assignment, Sybil resistance, and on-chain attestation remain open. Execution artifacts remain bound to `205e1ca`; GH-9 remains ready for explicitly approved external signing. |
...
- [~] Sprint 10B ensemble voting: GH-36/39 plus GH-42 are merged/exact-main verified. GH-44 persistent identity and isolated relay/AutoNAT/DCUtR-fallback/disconnect evidence are candidate-complete; protected merge, public/multi-host operation, broad discovery, trusted membership/key assignment, Sybil resistance, and on-chain attestation remain
