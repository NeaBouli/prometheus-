...
- [~] Sprint 9: H-001 canary handoff is locally ready and non-promotable; real funded/signature/receipt/evidence execution is external. Full rollout remains blocked on the remaining state contracts, signed metrics-oracle operation, and exact-commit release hardening
...
*Prometheus v4.0 · Checkpoint 2026-07-16 · Last updated: GH-17 merged/exact-main green at `9477fab` + GH-9 public funding/identity and deterministic schema-v2 request/digest confirmed + canonical public-signature import hardening locally verified with PR/exact-main CI pending + external signature/broadcast/evidence pending + GH-13 experimental local miner companion accepted at `2e4b4ec` + seven current-Silverc runtime gates + crash-consistent keyless Toccata-v1 genesis operator + manifest-bound non-promotable H-001 testnet-10 profile + TLS-only official resolver probe + public receipts/evidence/status staging + metrics-oracle handoff + exact-commit release-hardening gates · The fire belongs to humanity.*
