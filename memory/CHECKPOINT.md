...
| Letzter grün verifizierter Commit | 26b7aa1 — docs: record governance auto tuning runtime ci |
...
2. git log --oneline -5              → aktuellen HEAD prüfen; letzter grün verifizierter Commit = 26b7aa1
