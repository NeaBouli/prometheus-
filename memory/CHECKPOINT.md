...
| Letzter grün verifizierter Produkt-/Tooling-Commit | 5209414 — ci: add silverc release bundle manifest |
...
2. git log --oneline -5              → aktuellen HEAD prüfen; letzter grün verifizierter Produkt-/Tooling-Commit = 5209414
