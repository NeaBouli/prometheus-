...
| Letzter grün verifizierter Produkt-/Tooling-Commit | 6cc000c — ci: verify external operator capability |
...
2. git log --oneline -5              → aktuellen HEAD prüfen; letzter dokumentierter grün verifizierter Produkt-/Tooling-Commit = 6cc000c
