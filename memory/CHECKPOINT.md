...
| Letzter grün verifizierter Produkt-/Tooling-Commit | `71e5783` — Prometheus CI `29457601210`, Security `29457601183`, and Pages `29457600490` green; public rollout/docs baseline remains `e9a970a` |
| Aktuelle Tooling-Baseline | All nine protected jobs are explicitly bounded and the pinned audit environment is exact-main verified. Execution artifacts remain bound to `205e1ca`; GH-9 public funding/live UTXO and the byte-identical schema-v2 signing request are ready for explicitly approved external signing. |
...
- [x] Sprint 10B hybrid routing software: 8B first, exact 70B escalation below `0.70`, fail-closed safety envelope, and unchanged `0.85` submission threshold under GH-33; live model wiring/calibration remains
