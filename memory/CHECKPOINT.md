...
| Letzter grün verifizierter Produkt-/Tooling-Commit | fa719fc — ci: fix metrics oracle tx result hash import |
...
2. git log --oneline -5              → aktuellen HEAD prüfen; letzter dokumentierter grün verifizierter Produkt-/Tooling-Commit = fa719fc
