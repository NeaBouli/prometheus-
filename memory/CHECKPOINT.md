...
| Letzter grün verifizierter Produkt-/Tooling-Commit | 4d7a6b8 — ci: verify public deploy receipt evidence |
| Aktuelle lokale Tooling-Erweiterung | Public node/explorer receipt-evidence verifier lokal und remote grün |
...
2. git log --oneline -5              → aktuellen HEAD prüfen; letzter dokumentierter grün verifizierter Produkt-/Tooling-Commit = 4d7a6b8
