...
| Aktuelle Tooling-Baseline | Exact main `b639a5bc` passed Prometheus CI `29471846882`, Security `29471846860`, and Pages `29471846338`; product baseline remains GH-44 `27c2edc31`. The GH-48 operated-sidecar candidate is locally verified but not yet merged. Public/multi-host operation, broad discovery, trusted membership/key assignment, Sybil resistance, and on-chain attestation remain open. Execution artifacts remain bound to `205e1ca`; GH-9 remains ready for explicitly approved external signing. |
...
| Status | Rollout-capable core estimated at 73-77% after local GH-48 operated-sidecar verification; post-Toccata canary execution and full rollout evidence remain gated. |
...
- [~] Sprint 10B ensemble voting: GH-36/39 plus merged GH-42/GH-44 and the locally verified GH-48 operated-service candidate are implemented. Public/multi-host operation, broad discovery, trusted membership/key assignment, Sybil resistance, and on-chain attestation remain
