...
| Letzter grün verifizierter Produkt-/Tooling-Commit | 181cde2 — ci: reject raw deploy receipt payloads |
...
2. git log --oneline -5              → aktuellen HEAD prüfen; letzter dokumentierter grün verifizierter Produkt-/Tooling-Commit = 181cde2
