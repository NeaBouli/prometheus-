...
- [~] GH-1 covenant-genesis capability gate — local deploy procedure/capability flow now binds transaction version 1, compiled-script P2SH, official funding-outpoint/unbound-output covenant-ID derivation, and funding-input binding after ID derivation; four tamper classes reject; remote PR CI pending
