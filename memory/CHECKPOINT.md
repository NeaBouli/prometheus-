...
| Letzter grün verifizierter Produkt-/Tooling-Commit | 8bf6a14 — ci: audit silverc release readiness |
...
2. git log --oneline -5              → aktuellen HEAD prüfen; letzter dokumentierter grün verifizierter Produkt-/Tooling-Commit = 8bf6a14
