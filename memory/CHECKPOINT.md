...
| Letzter grün verifizierter Produkt-/Tooling-Commit | `d0f78a9` — Prometheus CI `29464295373`, Security `29464295355`, and Pages `29464294890` green; GH-39 authenticated Guardian ballot intake is merged/exact-main verified |
| Aktuelle Tooling-Baseline | All nine protected jobs are explicitly bounded and the pinned audit environment is exact-main verified. GH-39 adds per-session BIP340 authentication plus persistent restart/concurrency/clock-rollback-safe replay/equivocation protection. Actual P2P transport/discovery/NAT traversal, trusted membership/key assignment, Sybil resistance, and on-chain attestation remain open. Execution artifacts remain bound to `205e1ca`; GH-9 public funding/live UTXO and the byte-identical schema-v2 signing request are ready for explicitly approved external signing. |
...
- [~] Sprint 10B ensemble voting: GH-36 local 5+ complete-ballot/strict-majority protocol and GH-39 BIP340 authenticated intake with persistent replay/equivocation protection are merged/exact-main verified. Actual P2P carrier/discovery/NAT traversal, trusted membership/key assignment, Sybil resistance, and on-chain attestation remain
