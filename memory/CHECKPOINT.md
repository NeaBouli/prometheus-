...
- [~] Q-003: fp_rate Oracle — current-Silverc contract gate uses signed metrics input; public report preflight, unsigned tx-request builder, public tx-result verifier, and public status-draft staging are local/CI-covered; external transaction assembly/signing/broadcast/deploy operation pending
