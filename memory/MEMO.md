...
| 2026-07-31 | H-001 exact-main Readiness-Refresh | Codex Audit | Exact main `0b0b743` reproduziert den akzeptierten `205e1ca` Handoff bytegleich und revalidiert den öffentlichen UTXO; Signatur, Broadcast und Chain-Evidenz bleiben gesondert freizugeben |
