...
- [ ] [P1] GH-161 derive Guardian candidate model digest from exact owner-local artifacts | Codex Sol + Kimi K3 | Implementation complete in protected PR #162 from exact main `fbd3733`; exact-main publication pending; canonical manifest and capture-time re-verification only, no upstream authenticity or production model authority
