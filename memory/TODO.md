...
- [~] [P1] GH-152 permanent governed ThreatHint-v2 identity pairing | Codex Sol + Kimi K3 | Schema v5 atomically and permanently binds statement digest, approval ID and observable commitment across retention; 63 focused and 1050/4 full Guardian tests pass, Kimi final review PASS with no P0-P2, protected publication remains
