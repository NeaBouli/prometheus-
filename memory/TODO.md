...
- [~] [P0] GH-30 Required-Check-Laufzeiten begrenzen und Audit-Toolchains pinnen | Codex | Issue #30 / `fix/GH-30-ci-runtime-bounds`; alle neun geschützten Kontextnamen bleiben unverändert, PR/exact-main Evidenz ausstehend
