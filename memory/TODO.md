...
- [~] [P1] Local canonical ThreatHint v2 statement | Codex + Terra/Spark review | GH-114 candidate adds independent Rust/Python exact canonical parsers and one shared 8-valid/20-invalid byte corpus for separate artifact hash and observable commitment plus confidence, structural disclosure class, nonce, time, and separately trusted network; focused tests and lint pass; full gates, protected PR, exact-main, and live verification remain
