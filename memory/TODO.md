...
- [~] [P2] Remediate `RUSTSEC-2026-0221` in transitive `event-listener` | Codex Sol | GH-132 lockfile-only 5.4.1 to 5.4.2 candidate removes the advisory; complete local gates and independent no-finding review pass; protected publication remains
