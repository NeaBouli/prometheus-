...
- [~] [P2] fp_rate Oracle Contract + Integration | Claude Code | Current-Silverc contract gate uses signed metrics `fp_rate` input; public metrics report preflight, unsigned oracle tx-request builder, and public oracle tx-result verifier pass locally and in CI; external transaction assembly/signer/broadcast/deploy operation pending
