...
- [~] [P0] GH-9 kanonischen Public-Signature-Import härten | Codex | `import-signature` binds plain 64-byte BIP340 hex to the validated request, rejects normalized path collisions, verifies before output, and passes 38 focused tests plus independent review locally; PR/exact-main CI pending
