...
- [~] [P1] Implement ensemble voting protocol: 5+ 8B Guardians vote on same YARA rule via majority | Codex | GH-36/39 plus merged/exact-main GH-42/GH-44/GH-48/GH-52 are implemented. GH-242 binds establishment to GH-147; GH-246 locally adds owner-pinned signed transition continuity and durable anti-rollback/current-source enforcement. Protected review remains. Externally trusted authority, key ownership/rotation, public/multi-host operation, broad discovery, Sybil resistance, on-chain attestation, and production evidence remain
