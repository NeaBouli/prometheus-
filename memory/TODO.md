...
- [x] [P1] GH-242 bind local ballot sessions to the canonical membership source | Codex Sol + Kimi K3 | PR #243 merged normally as exact main `5cb132c670d1e7771ccaf6dab2ddf5b1a6fd905a`; CI `33433012614`, Security `33433012605`, and Pages `33433011653` pass. Owner-load once; separately trusted network/epoch; internal snapshot/signer derivation; no public caller-context registration; unchanged ballot wire, replay and ensemble math. Production authority remains false
