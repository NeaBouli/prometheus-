...
- [ ] [P0] Hello-World Silverscript Contract auf Testnet deployen | Codex | NEXT: requires a real funded testnet-10 UTXO and external vault/HSM signature response; collect confirmed receipt plus independent node/explorer evidence
