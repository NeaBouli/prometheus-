...
- [x] [P0] GH-9 H-001 handoff von aktuellem exact main neu bauen | Codex | 2026-07-31 exact main `0b0b743` reproduced the accepted `205e1ca` seven-artifact archive/request/signing request, live-revalidated the public UTXO, passed owner-only modes, full-directory Gitleaks, full Rust/Guardian gates, and independent review; external signature/broadcast/evidence remain
