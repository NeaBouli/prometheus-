...
- [~] [P1] GH-207 durable RuleStorage anti-downgrade checkpoint | Codex Sol + Kimi K3 | Local implementation and focused adversarial tests in progress; protected PR, exact-main evidence and live Pages readback remain; production authority remains false
...
- [~] [P1] Regel-Download von IPFS via CIDv1 | Codex Sol + Kimi K3 | GH-190 through GH-207 provide bounded exact-byte verification, restricted loopback gateway fetch, atomic complete-snapshot activation and owner-local restart-persistent rollback/equivocation rejection; canonical L1 authority, autonomous replicated IPFS operation and production YARA remain
