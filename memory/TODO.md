...
- [~] [P1] Regel-Download von IPFS via CIDv1 | Codex Sol + Kimi K3 | GH-190 implements bounded local Raw-CIDv1/exact-byte verification, strict simple-matcher parsing and atomic snapshot activation; canonical L1 reads, IPFS network fetching, production YARA and durable anti-downgrade state remain
