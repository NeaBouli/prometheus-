...
- [~] [P1] GH-147 canonical Guardian membership source and public-key assignment | Codex Sol + Kimi K3 | Local implementation, vectors, 198 focused tests, Guardian 1043 pass/4 skip, Black 30, changed Pylint 10.00 and full Pylint 9.84 pass. Protected PR, review, merge and exact-main CI/Security/Pages remain; external source authority, key ownership/rotation, Sybil resistance and L1 attestation remain separate work
