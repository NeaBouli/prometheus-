...
- [~] [P2] P2P-Grundgeruest (p2p.rs mit libp2p) | Kimi K3 + Codex | GH-226 schliesst den Development-only v1 Einzelsender; GH-234/PR #235 code `b450740` ergaenzt den Development/Testnet-10-only v2 Einzelsender fuer owner-prepared canonical payloads mit realem same-host Binary/QUIC-Test. Oeffentliches Multi-Host-v2-Netz, Membership/Discovery, Proof-/Approval-Autoritaet und Produktion bleiben offen
