...
- [~] [P2] Resolve M-002 debug commitment benchmark flakiness without weakening the release target | Codex Sol | GH-131 locally passes with a warmed 65-sample median, a 2ms debug smoke budget, and an explicit optimized CI run with the strict 1ms budget; protected CI and exact-main evidence remain
