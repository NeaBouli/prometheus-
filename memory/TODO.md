...
- [ ] [P1] GH-161 derive Guardian candidate model digest from exact owner-local artifacts | Codex Sol + Kimi K3 | In progress from exact main `fbd3733`; canonical manifest and capture-time re-verification only, no upstream authenticity or production model authority
