...
- [~] [P2] GH-155 Guardian sidecar process-test CI stability | Codex Sol + Kimi K3 | Fresh branch from exact main `d87d969`; implementation, 20-pass stress, full local gates and Kimi review PASS with no P0-P2 complete; protected PR/merge/exact-main evidence remains; test-only, no production behavior
