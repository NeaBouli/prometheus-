...
- [ ] [P1] Local Threat Observable bundle validators and vectors | Codex + helper agents | Implement matching Rust/Python canonical validation and commitment against shared valid/invalid fixtures; no v2 wire, proof relation, analyzer side effect, or reviewed-disclosure transport
