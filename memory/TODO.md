...
- [ ] [P1] GH-258/GH-261 Endpoint Detection & Safe Response | Core Dev + independent security/privacy review | Planned only. Include unauthorized compute conscription of endpoints, accelerators, servers, or data-center capacity into a distributed mesh. Build in gated slices: opt-in least-privileged telemetry for process/resource ownership, unexpected CPU/GPU workloads, scheduler/orchestrator drift, workload identity, persistence, credentials and outbound fan-out; local warning and evidence; operator-confirmed reversible containment; separately approved limited automation. Behavior-based detection only, with no reliable AI/AGI/actor attribution. No real-time sensor, response engine, automatic quarantine/process kill/firewall/credential rotation/remote command/deletion/host isolation is implemented or authorized. Requires real-sample/adversarial, false-positive, privacy, multi-host and rollback evidence before any response authority
