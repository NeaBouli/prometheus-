...
- [~] [P1] GH-216 binary-level RuleStorage sync loopback E2E evidence | Codex Sol + Kimi K3 | Issue #216 / branch `test/GH-216-rule-sync-loopback-e2e`; test-only Borsh wRPC/IPFS peers, real process signals, restart/replay/anti-downgrade and bounded adversarial failures; no real-node/Testnet operation, production source, key authority, wallet, chain, deployment, Mainnet or production claim
