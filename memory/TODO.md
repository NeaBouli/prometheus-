...
- [~] [P1] Light Client ↔ Guardian P2P Kommunikation | Codex | GH-55 canonical schema, client builder, and independent direct P2P request/ACK core are merged/exact-main verified. Operated acceptance remains fail-closed until real Groth16 verification, freshness/replay persistence, dedicated owner-only ingress, and bounded analyzer admission exist
