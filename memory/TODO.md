...
- [~] [P0] Silverscript Compiler/Tooling installieren und testen | Claude Code | Upstream `silverc` builds/tests locally; H-001 fixture verifies; ValidatorStaking state fixture compiles; runtime transition tests pending
...
- [ ] [P1] Alle Contracts auf Testnet deployen und Adressen in STATUS.md eintragen | Claude Code | Wartet auf current-Silverscript runtime transition tests + remaining deployment-scoped contract ports
...
- [~] [P1] Commit-Reveal vollständig in Silverscript implementieren | Claude Code | H-001 runtime fixture + ValidatorStakingState compile/ABI gate done; runtime transition tests pending
