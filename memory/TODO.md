...
- [~] [P1] Local Observable Approval v1 verifier | Codex + Claude Code review | GH-107 candidate on `feat/GH-107-local-observable-approval`; matching Rust/Python canonical BIP340 verification, shared public-only vector, exact trusted context and one-hour validity cap implemented locally; no signer, replay ledger, transport, promotion, disclosure, analyzer, proof, wallet, or chain wiring; protected PR/exact-main evidence pending
