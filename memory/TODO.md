...
- [~] [P1] GH-177 isolated synthetic YARA semantic-quality gate | Codex Sol + Kimi K3 | 20-case deterministic in-memory corpus, exact corpus/policy/evaluator/engine binding, strict authority-none report, 26 focused and 1295/4 full Guardian tests, complete local gates and no-finding final review pass; protected PR/CI/merge pending
