...
Current remote verification baseline: exact product/public main `42acbca54ed14ca5a74f21eff8484d2b3361d7b3` passed Prometheus CI `30676094287`, Security Audit `30676094290`, and Pages `30676093914`. All ten required contexts are bounded and green through merged GH-131 M-002 performance hardening and GH-132 dependency remediation. The embedded 2026-07-31 read-only H-001 refresh from `143a8a0` reproduced the accepted `205e1ca` archive/request/signing request and revalidated the live funding output. Real two-host Guardian operation, production v2 relation/artifact approval, independent cryptographic/privacy review, v2 transport, semantic/actionable analysis, and H-001 execution gates remain open.
...
- M-001/GH-135: the local candidate removes indicator-count/YARA-shape scoring, requests a separate model assessment, accepts only exact integer `confidence_bps` through a closed JSON/completion schema, and preserves the `0.85` threshold; complete gates, protected publication, live-model semantic/adversarial evaluation, and calibration evidence remain. M-002 and GH-132 are merged and exact-main verified at `42acbca`.
```
