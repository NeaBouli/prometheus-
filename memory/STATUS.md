...
- Oracle: integrate the signed metrics-oracle transaction builder/signer for GovernanceAutoTuning before beta/mainnet governance; public report preflight now exists
